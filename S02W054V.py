# -*- coding: utf-8 -*-
"""
Created on Fri Mar 12 10:14:17 2021
...
signal_tag = 7 #(1=2, 2=10, 3=20, 4=30, 5=40, 6=50, 7=60, 8=70)MeV
...
if doWeightedFit:
    ...
    history = model.fit(X_train, y_train, epochs=500, batch_size=10, sample_weight= w_train,
